...
def Action(send) :   
    ...
    if "what is your name" in   data_btn :
      speak.speak("my name is VIRA")  
      return "my name is VIRA"

    elif "hi" in data_btn or "hello" in data_btn  or "hye" in data_btn  or "hay" in data_btn: 
       ...
       return ans
        ...
        try:
            response = model.generate_content(
                f"Reply shortly in 1 or 2 lines only: {send}"
            )
